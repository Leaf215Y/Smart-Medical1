...
using Smart_Medical.Blazor.WebApp.Client;
using Smart_Medical.Blazor.WebApp.Client.Menus;
using Smart_Medical.Blazor.WebApp.Components;
...
[DependsOn(
    ...
    typeof(Smart_MedicalHttpApiModule),
    ...
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                ...
                typeof(Smart_MedicalDomainModule).Assembly,
                typeof(Smart_MedicalDomainSharedModule).Assembly,
                typeof(Smart_MedicalApplicationModule).Assembly,
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles(new BundleFile("/Smart_Medical.Blazor.WebApp.Client.styles.css", true));
                }
            );
        });
    }
    ...
    private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
    {
        if (hostingEnvironment.IsDevelopment())
        {
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<Smart_MedicalDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Smart_Medical.Domain"));
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<Smart_MedicalApplicationModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Smart_Medical.Application"));
